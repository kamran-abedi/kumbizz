...
commands_list_text = "/balance برای گرفنم موجودی \n/beg برای گدایی کردن\n/shop برای دسترسی به فروشگاه\n/level برای گرفتن سطحتون\n/imventory برای دیدن دارایی هاتون"
...
def commands(message):
    bot.reply_to(message, commands_list_text)

...
🎣 /fish - ماهیگیری  
🐗 /hunt - شکار  
👨‍🌾 /farm - برداشت از مزرعه  
⛏ /mine - استخراج از معدن  
/work - کار کردن  
/beg - گدایی

🍽 /cook - پخت غذا  
/eat [نام غذا] - مصرف غذا

🧩 /craft - ساخت آیتم‌های خاص  
/upgrade [معدن/مزرعه] - ارتقاء معدن یا مزرعه
...
/bank - بررسی موجودی بانکی

💸 /rob (ریپلای) - دزدی از دیگران

🛒 /list [نام آیتم] [قیمت] - آگهی آیتم در بازار  
/market - دیدن بازار آزاد  
/market [فیلتر] - فیلتر بازار  
/trade [آی‌دی آگهی] - خرید از بازار  
/cancel [آی‌دی آگهی] - لغو آگهی فروش

📊 /profile - اطلاعات پروفایل (لول، xp و...)  

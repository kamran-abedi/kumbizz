...
factory_sellable = [
    ...
    {"name": "شمع طبی", "base_price": 1700},          # عسل + گیاه دارویی ≈ 800 → 1700
    ...
    {"name": "زره آهنین", "base_price": 2200},        # آهن + پشم*2 = 1200 → 2200
    {"name": "پاپ کورن", "base_price": 1200},         # ذرت = 500 → 1200
    {"name": "آجر", "base_price": 850},               # سنگ*2 = 300 → 850
    {"name": "بالشت", "base_price": 3500},            # پر*2 = 1600 → 3500
    {"name": "پنیر", "base_price": 900},              # شیر*2 = 360 → 900
    {"name": "نون و پنیر", "base_price": 3200},       # نان*2 + پنیر = 2200 → 3200
    {"name": "کره", "base_price": 1200}                # شیر ×3 = 540 → 1200
]
